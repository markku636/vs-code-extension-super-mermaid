...
> 📷 更多實際效果(九種圖表類型、Gallery、前後對比)見 **[docs/DEMO.md](docs/DEMO.md)**;圖表原始碼在 [examples/demo.md](examples/demo.md),裝好擴充套件後打開它就能直接玩。
...
循序圖、ER、甘特、心智圖⋯⋯九種圖表類型的完整效果見 **[docs/DEMO.md](docs/DEMO.md)**。
